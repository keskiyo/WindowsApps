		...
		<section className='grid min-h-[55vh] place-items-center px-4 text-center'>
			<div className='relative w-full max-w-md rounded-2xl border border-white/8 bg-slate-900/55 px-8 py-10'>
				...
				<button
					...
					disabled={isScanning}
					onClick={() => void onScan()}
					className='mt-6 rounded-xl bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-400 focus-visible:outline-2 focus-visible:outline-blue-300 disabled:opacity-60'
				>
