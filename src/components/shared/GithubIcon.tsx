...
/**
 * GitHub mark as a local inline SVG. lucide-react deprecated its brand icons (`Github`, …) and
 * will remove them; this keeps the logo without depending on a deprecated export. `currentColor`
 * lets it inherit the surrounding text color like the other icons.
 */
