			...
			<div className='mx-auto flex w-full max-w-375 flex-col gap-4 px-5 py-5 sm:px-8 lg:flex-row lg:items-center'>
				...
				<div className='flex flex-1 items-center gap-3 lg:justify-end'>
					...
					<button
						...
						className='grid size-11 shrink-0 place-items-center rounded-xl bg-blue-500 text-slate-950 hover:bg-blue-400 focus-visible:outline-2 focus-visible:outline-blue-400 disabled:opacity-60'
					>
						<RefreshCw
