...
export function AppActionsMenu({
	...
	return (
		<div
			...
			className='absolute left-2 top-11 z-110 w-55 rounded-xl border border-white/10 bg-slate-900 p-1.5 text-left shadow-2xl shadow-black/40'
		>
			...
			{!isHidden && !app.canUninstall && (
				<button
					...
					role='menuitem'
					disabled
					className='flex w-full cursor-not-allowed items-center gap-2 rounded-lg px-3 py-2 text-sm text-slate-600'
				>
